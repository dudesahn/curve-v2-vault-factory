...
from utils import harvest_strategy, increase_time
import pytest
...
def test_check_rewards(
    ...
    if test_donation:
        ...
        if which_strategy == 1 and try_blocks:
            ...
            proxy.claimRewards(gauge, rewards_token, sender=strategy)
    ...
    if test_donation:
        rewards_token.transfer(strategy, rewards_amount, sender=rewards_whale)
        increase_time(chain, sleep_time)
